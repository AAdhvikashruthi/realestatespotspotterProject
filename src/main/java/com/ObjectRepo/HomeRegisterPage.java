...
public class HomeRegisterPage {
	...
	public void mobileData() throws Throwable
	{
		ExcelUtils eLib=new ExcelUtils();
		JavaUtils jLib=new JavaUtils();
		int ram = jLib.getRandomNo();
		String mvalue = eLib.readDataFromExcel("HOME", 7, 3);
		Mobile.sendKeys(mvalue+ram);
	}
	
	public void homeReg(HashMap<String,String> map, WebDriver driver,JavaUtils jLib,String email)
	{
	    ...
	    Image.sendKeys("C:\\Users\\SHRU\\Pictures\\anupama");
	    Submit.click();
	}
